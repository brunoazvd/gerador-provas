...
type GetAuthenticatedUserSuccessResponse =
  TypedResponse<GetAuthenticatedUserSuccessResponseBody>;
type AuthSuccessResponse = TypedResponse<AuthSuccessResponseBody>;
type AuthErrorResponse = TypedResponse<AuthErrorResponseBody>;
type RefreshAcessTokenSuccessResponse =
  TypedResponse<RefreshAcessTokenSuccessResponseBody>;
